...
const handleFaqClick = (index) => {
  ...
  return (<>
    {
      ...
      <h1 className={`name-${theme} text-center`}>{currentUser.username}</h1>
    ...
    
    {
      theme !== "undefined" && theme === 'theme3' && ( <div>
       ...
       <h1 className="font-bold text-3xl mb-3">Family Restaurant</h1>
  ...
  <div className=' p-3 bg-slate-200 mb-5 rounded-md flex justify-center items-center'>
